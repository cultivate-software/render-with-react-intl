...
>
> ```
> git remote add upstream https://github.com/cultivate-software/render-with-react-intl.git
> git fetch upstream
...
Please check out the [open issues](https://github.com/cultivate-software/render-with-react-intl/issues) page on GitHub.
